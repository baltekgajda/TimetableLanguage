...
public class TTVisitor extends ttBaseVisitor<Variable> {
    ...
    public Variable visitDeclaration_statement(ttParser.Declaration_statementContext ctx) {
        ...
        if (ctx.timetable_data_declaration() != null)
            return visitTimetable_data_declaration(ctx.timetable_data_declaration());
        return null;
    }
    ...
    public Variable visitAssignement_statement(ttParser.Assignement_statementContext ctx) {
        ...
        if (ctx.timetable_data_assignment() != null)
            return visitTimetable_data_assignment(ctx.timetable_data_assignment());
        return null;
    }
    ...
    public Variable visitTimetable_statements(ttParser.Timetable_statementsContext ctx) {
        ...
        if (ctx.print_tt_data_statistics() != null)
            return visitPrint_tt_data_statistics(ctx.print_tt_data_statistics());
        return null;
    }
